    ...
    <div class="main">
      ...
      <div class="hero">
        <form class="register-form" action="/food2go/register.php" method="post">
          ...
          <div class="content1" style="display: flex; align-items: flex-end">
            <label style="color: #fc5122; font-weight: bold">Birthday:</label>
            <div class="item" style="display: block">
              <label style="color: #ffae00">Month:</label>
            ...
            <div class="item" style="display: block">
              <label style="color: #41ad17">Day:</label>
            ...
            <div class="item" style="display: block">
              <label style="color: #02d0c7">Year:</label>
